...
class FakeAgent:
    ...
    async def start(self, channel_name, agent_uid, user_uid, output_audio_codec=None, model="models/gemini-3.8-live", thinking_level=None):
        self.started.append((channel_name, agent_uid, user_uid, output_audio_codec))
        self.selection = (model, thinking_level)
        return {
