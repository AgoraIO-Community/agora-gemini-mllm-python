# agora-gemini-mllm (Python) — Repo Card

> Gemini 3.8 Live model comparison demo: Next.js client + FastAPI backend using the published Agora Agent SDK.
...
| [06_interfaces](L1/06_interfaces.md)     | FastAPI route contracts, rewrites, env vars, Gemini MLLM payload     | Use & Maintain |
