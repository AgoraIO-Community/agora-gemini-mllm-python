...
Documentation navigation tested: 2026-05-28; release web verification: 2026-09-15
...
| `bun run verify:web` | Pass (2026-09-15) | Doctor, API contracts, and production build passed with network access. The 2026-05-28 sandbox attempt could not fetch Google Fonts. |
